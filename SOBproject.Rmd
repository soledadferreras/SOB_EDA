...
```{r figure3, fig.margin = TRUE, fig.width=4.5, fig.height=4.5, cache=TRUE, message=FALSE, warning=FALSE, echo=FALSE}
...
```{r, figure6, message=FALSE, fig.fullwidth = TRUE, out.width="100%", echo=FALSE}
